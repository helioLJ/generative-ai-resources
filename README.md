...
- [Entendendo Como ChatGPT Funciona - Rodando sua Própria IA](https://youtu.be/O68y0yRZL1Y?si=tLMgqdREnfgkuyq5)
...
## Outras Plataformas e Documentação
- [LangChain](https://python.langchain.com/docs/get_started/introduction)
- [Azure OpenAI](https://learn.microsoft.com/pt-br/azure/?product=popular)

## Projetos GitHub
- [Product Recommendation Email Generator](https://github.com/helioLJ/gpt-and-python/blob/main/creating-tools/product_recommendation_email_generator.py)
